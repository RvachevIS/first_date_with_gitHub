...
# 100 игроков, узнаем какое среднее количество ходов для поражения
HEADS = "heads"
TAILS = "tails"
...
def simulate_martigale_for_n_players(*,
    ...
    for i in range(n_games):
        step_to_loose = play_martingale(starting_funds=starting_funds,
                                        min_bet=min_bet,
                                        max_bet=max_bet
                                        )
...
if __name__ == '__main__':
    print(simulate_martigale_for_n_players(n_games=10,
                                           starting_funds=1000,
                                           min_bet=1,
                                           max_bet=100)
                                            )
